      ...
      <Helmet>
        ...
        <meta
          ...
          content={
            ...
            `Explore ${property.title}, available now with our real estate platform.`
          }
        />

        <link
          rel="canonical"
          href={`https://yourwebsite.com/properties/${property.id}`}
        />

        {/* Open Graph */}
        <meta property="og:title" content={`${property.title} | Real Estate`} />

        <meta
          property="og:description"
          content={property.description || `Explore ${property.title}.`}
        />
        ...
        <meta
          property="og:url"
          content={`https://yourwebsite.com/properties/${property.id}`}
        />
      </Helmet>
            ...
            <aside className="h-fit lg:sticky lg:top-24">
              <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-500">
                  Contact our property expert to learn more about this property
